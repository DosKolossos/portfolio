...
export class ReferencesComponent {
  ...
  comments: Comments[] = [
    ...
    },
    {
      ...
      // commentDE: "David hat in unserer Gruppenarbeit immer sehr genau gearbeitet und auf jede Feinheit geachtet. Mit seinem Humor hat er regelmäßig für gute Laune im Team gesorgt. Seine offene und aktive Kommunikation war dabei eine große Hilfe, um alle auf dem gleichen Stand zu halten.",
      project: "Project Join",
      // projectDE: "Projekt Join"
    },
    {
